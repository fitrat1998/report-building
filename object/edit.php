                               ...
                               <div class="row mb-3" >
                                  ...
                                  <div class="col-lg-4">
                                    ...
                                    <label>Object name</label>
                                     <input type="text" name="object_name" class="form-control" placeholder="Name of object" required style="background-color: #F8F8F8 !important;" value="<?=$res['obj_name'];?>">
                                  </div>
                                  ...
                                  <div class="col-lg-4 m-b-10">
                                    <i class="fa fa-parking"></i>
                                       ...
                                       <select name="section[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:350px !important; ">
                                        <?php 
