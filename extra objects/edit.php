...
$sql = mysqli_query($link,"SELECT * FROM sections WHERE id = '$id'");
                                ...
                                <div class="row mb-3" >
                                  <div class="col-lg-4">
                                    ...
                                    <label>Extra object name</label>
                                     <input type="text" name="name" class="form-control" placeholder="Name of object" required style="background-color: #F8F8F8 !important;" value="<?=$res['section_name'];?>">
                                  </div>
                               </div>
