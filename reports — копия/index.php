                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php
                                       $id = $row['worker_id'];
                                       $sql2 = mysqli_query($link,"SELECT * FROM workers WHERE id = '$id'");
                                       $res2 = mysqli_fetch_assoc($sql2);
                                       echo $res2['name'];
                                       ?>
                                 </td>
                                 ...
                                 ?>
                                 <td><a href="edit.php?id=<?=$row['id']?>"><i class="fa fa-pencil btn-success p-10"></i></td>
                                 <td>
