...
$sql = mysqli_query($link,"SELECT * FROM workers WHERE id = '$id'");
                                ...
                                <div class="row mb-3" >
                                  <div class="col-lg-4">
                                    ...
                                    <label>Worker name</label>
                                     <input type="text" name="name" class="form-control" placeholder="Name of worker" required style="background-color: #F8F8F8 !important;" value="<?=$res['name'];?>">
                                  </div>

                                  <div class="col-lg-4">
                                    <i class="fa fa-phone"></i>
                                    <label>Phone</label>
                                     <input type="text" name="phone" class="form-control" placeholder="Phone number of worker" required style="background-color: #F8F8F8 !important;" value="<?=$res['phone'];?>">
                                  </div>
                               </div>
