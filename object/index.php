                             ...
                             <form method="POST" id="object" >
                                <div class="row mb-3" >
                                  ...
                                  <div class="col-lg-4">
                                       ...
                                       <select name="ob_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:350px !important; ">
                                        <?php 
                               ...
                               <div class="row mb-3" >
                                ...
                                <div class="col-lg-3">
                                       ...
                                       <select name="floor_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:250px !important; ">
                                        <?php 
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <label>Flats</label>
                                     <input type="text" name="rooms" class="form-control" placeholder="Flats must fill like 1/10" required style="background-color: #F8F8F8 !important;">
                                  </div>

                                  <div class="col-lg-3">
                                       <i class="fa fa-parking"></i>
                                       <label>Extra section of Flat</label><br>
                                       <select name="flat_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:250px !important; ">
                                        <?php 
