...
<html dir="ltr" lang="en">
   <head>
      ...
      <title>ROBO-FINISH SECTION</title>
      <!-- Custom CSS -->
         ...
         <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
               <div class="row">
                  <div class="col-12 d-flex no-block align-items-center">
                     ...
                     <h4 class="page-title">
                        <button onclick="myFunction()" class="font-light text-white ml-2 btn btn-primary" >
                    <span style="font-size:14px !important;">Add section <i class="fa fa-plus"></i></span>
                   </button  name="add"><br>
                     </h4>
            ...
            <div class="container-fluid">
               ...
               <div id="card" >
                                 ...
                                 <div class="row mb-3" >
                                    ...
                                    <div class="col-lg-3" id="test">
                                       ...
                                       <select  name="object_name" class="form-control object" placeholder="Address" required 
                                          style="background-color: #F8F8F8 !important;" id="object">
                                          <option>Choose object</option>
                                           <?php
                                                $i = 0; 
                                                while($rows = mysqli_fetch_assoc($sql)){
                                                   ?>
                                                   <option value="<?=$rows['obj_name'];?>"><?php echo $rows['obj_name'];?></option>
                                                   <?
                                                }
                                          ?>
                                    ...
                                    <div class="col-lg-3" id="test">
                                             ...
                                             <label>extra sections of object</label>
                                             <select  name="section" class="form-control object" placeholder="Address" required 
                                                ...
                                                <?php 
                                                 $sql2 = mysqli_query($link,"SELECT * FROM objects GROUP BY section HAVING COUNT(obj_name) > 0");
                                                   while ($rows2 = mysqli_fetch_assoc($sql2)) {
                                                   $sections = explode(",",$rows2['section']);
                                                   array_pop($sections);
                                                   foreach($sections as $key => $value){
                                                   $sql = mysqli_query($link,"SELECT * FROM sections WHERE id = '$value'");
                                    ...
                                    <div class="col-lg-3">
                                       ...
                                       <select name="worker[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:280px!important; ">
                                        <?php 
                                   ...
                                   <!--  <div class="col-lg-3">
                                       <label>Finish</label><br>
                                        <input name="status" class=" form-control flexCheckDefault " type="checkbox" value="true" id="flexCheckDefault" style="width:50px !important;height: 35px;background-color:red !important;" >
                                    </div> --> 
                                 </div>
                ...
                <div class="card">
                    <div class="card-body">
                       <h3 class="card text-center"><i class="fa fa-bath"></i> Section of object</h3><hr>
                        <div class="table-responsive">
                            ...
                            <table id="example" class="display nowrap example" style="width:100%">
                                ...
                                <tbody>
                                  <?php 
                                        $sql2 = mysqli_query($link,"SELECT * FROM extra_object WHERE floor < 1 AND flat < 1");
                                        while($row2 = mysqli_fetch_assoc($sql2)){?>
                                          ...
                                          <td><?=date("Y-m-d",$row2['created_date'])?></td>
                                            <td>
                                            <?php
                                                if($row2['updated_date']) echo date("Y-m-d",$row2['updated_date']);
                                                else echo 0;
                                            ?>
                                          </td>
                                    
                                          <td><a href="edit.php?id=<?=$row2['id']?>"><i class="fa fa-pencil btn-success p-10"></i></a></td>
                                          <td>
                                            <form id="delete" class="">
                                            <button type="button" class="btn btn-danger uchir" salom="<?=$row2['id']?>"><i class="fa fa-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                        <?}
