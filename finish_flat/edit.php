                              ...
                              <form method="POST" id="edit" >
                                 ...
                                 <div class="row mb-3" >
                                    ...
                                    <div class="col-lg-4" id="test">
                                       ...
                                       <input type="text" name="object_name" class="form-control object" placeholder="Address" style="background-color: #F8F8F8 !important;" id="object" value="<?=$res['object_name']?>">
                                    </div>

                                    <div class="col-lg-4">
                                       <i class="fa fa-house"></i>
                                       <label>Flat</label><br>
                                       <input type="text" name="flat" class="form-control object" value="<?=$res['flat']?>" style="background-color: #F8F8F8 !important;">
                                    </div>
                                 ...
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-lg-4" id="test">
                                       ...
                                       <select name="section[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width: !important; ">
                                        <?php 
                                          $sql = mysqli_query($link,"SELECT * FROM sections WHERE parent = 'fla'");
