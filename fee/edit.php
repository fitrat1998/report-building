                               ...
                               <h3 class="text-center border-bottom m-b-20">Updating</h3>
                                <div class="row mb-3" >
                                     <div class="col-lg-3">
                                       ...
                                       <input type="text" name="project" class="form-control" placeholder="project" required  style="background-color: #F8F8F8 !important;" value="<?=$res1['project_name']?>">
                                    ...
                                    <div class="col-lg-3" id="test">
                                       ...
                                       <label> Objects</label>
                                       <input type="texts" name="object" class="form-control" placeholder="object" required  style="background-color:#F8F8F8 !important;" value="<?=$res2['obj_name']?>">
                                    </div>
