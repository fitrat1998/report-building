...
$sql = mysqli_query($link,"SELECT objects.id, objects.obj_name, extra_object.section, SUM(extra_object.surface),extra_object.created_date,extra_object.updated_date
      FROM objects INNER JOIN extra_object ON objects.id=extra_object.object_id GROUP BY section HAVING COUNT(extra_object.section) > 0");
...
<head>
    ...
    <title>ROBO-REPORT SURFACE</title>
    <!-- Custom CSS -->
                           ...
                           <div class="row mb-3" >
                               <!--  -->
                                  ...
                                  <div class="col-lg-4" id="test">
                                    ...
                                    <label> Objects</label>
                                       <select name="object_name" class="form-control object" placeholder="Address" required id="object" onchange="t()">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example" class="display nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Object name</th>
                                        <th>Extra object name</th>
                                        <th>Surface</th>
                                        <th>Workers</th>
                                        <th>Created date</th>
                                        <th>Updated date</th>
                                        <th>Surface by worker</th>
                                        <th>Fee by worker</th>
                                        <th>Total</th>
