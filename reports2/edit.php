                                    ...
                                    <form method="POST" id="edit" >
                                       <div class="row mb-3" >
                                          ...
                                          <div class="col-lg-4">
                                            ...
                                            <label> Name of object</label>
                                             <input type="text" name="object" class="form-control" value="<?=$res['object_name'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>

                                           <div class="col-lg-4 m-b-10">
                                            <i class="fa fa-house"></i>
                                            <label> Flat</label>
                                            <input type="text"  class="form-control" name="flat" style="background-color: #F8F8F8 !important;" value="<?=$res['flat'];?>">
                                          </div>
                                          ...
                                          <div class="col-lg-4">
                                            ...
                                            <label>Worker</label>
                                             <?php 
                                                $wk = explode(",",$res['workers']);
                                                    array_pop($wk);
                                                foreach ($wk as $key) {
                                                    $sql2 = mysqli_query($link,"SELECT * FROM workers WHERE id = '$key'");
                                                    $res2 = mysqli_fetch_assoc($sql2);
                                                    ?>
                                                        <input type="text" name="worker" class="form-control" value="<?=$res2['name'];?>" required style="background-color: #F8F8F8 !important;">
                                                    <?
                                                }
                                       ...
                                       <div class="row mb-3" >
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <label>Section</label> 
                                             <input type="text" name="section" class="form-control" value="<?=$res['section'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>
