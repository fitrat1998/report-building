...
$sql = mysqli_query($link,"SELECT * FROM report_worker WHERE id = '$id'");
$res = mysqli_fetch_assoc($sql);
$_SESSION['pr_id'] = $res['id'];

$id2 = $res['project_id'];
$sql2 = mysqli_query($link,"SELECT * FROM projects WHERE id = '$id2'");
$res2 = mysqli_fetch_assoc($sql2);

$id3 = $res['object_id'];
$sql3 = mysqli_query($link,"SELECT * FROM objects WHERE id = '$id3'");
$res3 = mysqli_fetch_assoc($sql3);

$id4 = $res['worker_id'];
$sql4 = mysqli_query($link,"SELECT * FROM workers WHERE id = '$id4'");
                                    ...
                                    <form method="POST" id="edit" >
                                       <div class="row mb-3" >
                                          <div class="col-lg-4">
                                            ...
                                            <label> Name of project</label> 
                                             ...
                                             <input type="text" name="project" class="form-control" value="<?=$res2['project_name'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>
                                          <div class="col-lg-4">
                                            <i class="fas fa-hospital"></i>
                                            <label> Name of object</label>
                                             <input type="text" name="object" class="form-control" value="<?=$res3['obj_name'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>

                                          <div class="col-lg-4">
                                            <i class="mdi mdi-worker"></i>
                                            <label>Worker</label>
                                             <input type="text" name="worker" class="form-control" value="<?=$res4['name'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>
                                       ...
                                       <div class="row mb-3" >
                                          <div class="col-lg-3">
                                            ...
                                            <label>Floor</label> 
                                             <input type="text" name="floor" class="form-control" value="<?=$res['floor'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>
                                          
                                          <div class="col-lg-3 m-b-10">
                                            <i class="fa fa-house"></i>
                                            <label> Flat</label>
                                            <input type="text"  class="form-control" name="room" style="background-color: #F8F8F8 !important;" value="<?=$res['room'];?>">
                                          </div>

                                          <div class="col-lg-3">
                                            <i class="fa fa-calculator"></i>
                                            <label>Surface 2^m</label> 
                                             <input type="text" name="surface" class="form-control" value="<?=$res['surface'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>

                                          <div class="col-lg-3">
                                            <i class="fa fa-dollar-sign"></i>
                                            <label>Salary</label> 
                                             <input type="text" name="salary" class="form-control" value="<?=$res['salary'];?>" required style="background-color: #F8F8F8 !important;">
                                          </div>
