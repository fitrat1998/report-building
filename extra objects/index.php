<?php 
   ...
   $sql_project = mysqli_query($link,"SELECT * FROM sections");
...
<html dir="ltr" lang="en">
   <head>
      ...
      <title>ROBO-ADD EXTRA OBJECT</title>
      <!-- Custom CSS -->
      ...
      <div id="main-wrapper">
         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                 ...
                                 <form method="POST" id="worker" >
                                    <div class="row mb-3" >
                                       <div class="col-lg-4">
                                          ...
                                          <select type="text" name="position" class="form-control" placeholder="Name of extra object" required style="background-color: #F8F8F8 !important;">
                                       ...
                                       <div class="col-lg-4">
                                          ...
                                          <label>Extra object name</label>
                                          <input type="text" name="name" class="form-control" placeholder="Name of extra object" required style="background-color: #F8F8F8 !important;">
                                       </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <h3 class="card text-center"><i class="fa fa-square-parking"></i>
                        Add extra Sections 
                     </h3>
                     <hr>
                     <div class="table-responsive">
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                           ...
                           <tbody>
                              <?php 
                                 $sql = mysqli_query($link,"SELECT * FROM sections");
